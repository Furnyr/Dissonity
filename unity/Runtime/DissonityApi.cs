...
#nullable disable
        ...
        //# DEBUG - - - - -
#nullable enable
        public static string? OverrideAccessToken = null;
...
#nullable disable
        ...
        internal static GetStringDelegate _GetAccessTokenEvent;
        ...
        //# JAVASCRIPT PLUGIN - - - -
            ...
            [DllImport("__Internal")]
            private static extern string RequestAccessToken();
        ...
        public static Task<string> GetAccessToken()
        {
            ...
            if (cachedAccessToken != null)
            {
                ...
                tcs.TrySetResult(cachedAccessToken);
                return tcs.Task;
            }
            ...
            _GetAccessToken((accessToken) =>
            {
                ...
                tcs.TrySetResult(OverrideAccessToken ?? "ph_access_token");
#endif
        ...
        private static void _GetAccessToken(GetStringDelegate del)
        {
