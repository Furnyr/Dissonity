...
type HiRpcShape<V extends string> = V extends StartWith<"0.5"> ? HiRpcV0_5 : V extends StartWith<"0.6"> ? HiRpcV0_6 : V extends StartWith<"0.7"> ? HiRpc : UnknownHiRpc;
